...
<div class="banner_section slide_wrap shop_banner_slider staggered-animation-wrap">
    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active background_bg" data-img-src="{{asset('frontend/assets/images/pembuka.png')}}">
            ...
            <div class="carousel-item background_bg" data-img-src="{{asset('frontend/assets/images/pembuka.png')}}">
                <div class="banner_slide_content banner_content_inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-md-8 col-sm-9 col-10">
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="single_banner">
                    <img src="{{asset('frontend/assets/images/furniture_banner1.jpg')}}" alt="furniture_banner1">
                    <div class="fb_info">
            ...
            <div class="col-md-7">
                <div class="single_banner">
                    <img src="{{asset('frontend/assets/images/furniture_banner2.jpg')}}" alt="furniture_banner2">
                    <div class="fb_info2">
                ...
                <div class="product_slider carousel_slider owl-carousel owl-theme nav_style4" data-loop="true"
                        ...
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="{{asset('frontend/assets/images/furniture_img1.jpg')}}" alt="furniture_img1">
                                </a>
                    ...
                    <div class="item">
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="{{asset('frontend/assets/images/furniture_img2.jpg')}}" alt="furniture_img2">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="shop-compare.html" class="popup-ajax"><i
                    ...
                    <div class="item">
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="{{asset('frontend/assets/images/furniture_img3.jpg')}}" alt="furniture_img3">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="shop-compare.html" class="popup-ajax"><i
                    ...
                    <div class="item">
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="{{asset('frontend/assets/images/furniture_img4.jpg')}}" alt="furniture_img4">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="shop-compare.html" class="popup-ajax"><i
                    ...
                    <div class="item">
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="{{asset('frontend/assets/images/furniture_img5.jpg')}}" alt="furniture_img5">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="shop-compare.html" class="popup-ajax"><i
                    ...
                    <div class="item">
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="{{asset('frontend/assets/images/furniture_img6.jpg')}}" alt="furniture_img6">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="shop-compare.html" class="popup-ajax"><i
                ...
                <div class="client_logo carousel_slider owl-carousel owl-theme" data-dots="false"
                    ...
                    <div class="item">
                        <div class="instafeed_box">
                            <a href="#">
                                <img src="{{asset('frontend/assets/images/furniture_insta1.jpg')}}" alt="furniture_insta1" />
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="instafeed_box">
                            <a href="#">
                                <img src="{{asset('frontend/assets/images/furniture_insta2.jpg')}}" alt="furniture_insta2" />
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="instafeed_box">
                            <a href="#">
                                <img src="{{asset('frontend/assets/images/furniture_insta3.jpg')}}" alt="furniture_insta3" />
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="instafeed_box">
                            <a href="#">
                                <img src="{{asset('frontend/assets/images/furniture_insta4.jpg')}}" alt="furniture_insta4" />
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="instafeed_box">
                            <a href="#">
                                <img src="{{asset('frontend/assets/images/furniture_insta5.jpg')}}" alt="furniture_insta5" />
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="instafeed_box">
                            <a href="#">
                                <img src="{{asset('frontend/assets/images/furniture_insta6.jpg')}}" alt="furniture_insta6" />
                            </a>
                        </div>
                    </div>
                </div>
